...
const file_proto_pubsub_proto_rawDesc = "" +
	"\n" +
	"\x12proto/pubsub.proto\x12\x05proto\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\x06PubSub\x124\n" +
	"\tSubscribe\x12\x17.proto.SubscribeRequest\x1a\f.proto.Event0\x01\x128\n" +
	"\aPublish\x12\x15.proto.PublishRequest\x1a\x16.google.protobuf.EmptyB\tZ\a/proto/b\x06proto3"
...
var file_proto_pubsub_proto_depIdxs = []int32{
	0, // 0: proto.PubSub.Subscribe:input_type -> proto.SubscribeRequest
	1, // 1: proto.PubSub.Publish:input_type -> proto.PublishRequest
	2, // 2: proto.PubSub.Subscribe:output_type -> proto.Event
	3, // 3: proto.PubSub.Publish:output_type -> google.protobuf.Empty
